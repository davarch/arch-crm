...
return [
    ...
    /*
     * Handlers are classes that build up projections. You can create them by performing
     * `php artisan event-sourcing:create-projector`. When not using auto-discovery,
     * Handlers can be registered in this array or a service provider.
     */
    'projectors' => [
        // App\Handlers\YourProjector::class
    ],
